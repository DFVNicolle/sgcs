            ...
            <div class="card bg-white shadow-xl">
                <div class="card-body">
                    <form action="{{ route('proyectos.elementos.store', $proyecto) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-control w-full mb-4">
                            <label class="label">
                                <span class="label-text font-semibold text-black">URL del Commit en GitHub</span>
                            ...
                            <input
                                ...
                                class="input input-bordered w-full bg-white text-black border-gray-300 @error('commit_url') border-red-500 @enderror"
                                id="commit_url_input"
                            />
                            @error('commit_url')
                                <label class="label">
                            ...
                            <label class="label">
                                <span class="label-text-alt text-gray-500">
                                    <strong class="text-black">Deja este campo vacío si aún no tienes código en GitHub.</strong> Puedes agregarlo después al editar el elemento.
                                </span>
                            </label>
                        </div>
