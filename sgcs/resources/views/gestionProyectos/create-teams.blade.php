            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center flex-1">
                                ...
                                <div class="ml-3">
                                    <div class="text-sm font-medium text-indigo-600">Paso 2</div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <h3 class="text-sm font-semibold text-gray-700 mb-2">Proyecto: {{ $proyectoData['nombre'] }}</h3>
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span class="text-gray-900 ml-2 capitalize">{{ $proyectoData['metodologia'] }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button
                                    type="button"
                                    onclick="addTeam()"
                                    class="btn bg-indigo-600 text-white hover:bg-indigo-700 border-0"
                                >
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <textarea
                                ...
                                class="textarea textarea-bordered w-full bg-white text-gray-900 border-gray-300"
                            ></textarea>
                        </div>
                    </div>
                </div>
